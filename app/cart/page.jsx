    ...
    <main className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="space-y-4">
        {items.map((item) => (
          <div
            key={item.productId}
            className="bg-white border border-[#1B2430]/10 rounded-xl p-4"
          >
            ...
            <div className="flex items-center justify-between gap-3">
              <input
                ...
                className="w-16 shrink-0 border border-[#1B2430]/15 rounded-md px-2 py-1 text-sm text-center focus:outline-none focus:border-[#6E7A52]"
              />
              ...
              <button
                ...
                className="text-[#1B2430]/40 hover:text-red-600 transition-colors shrink-0"
                title="Remove item"
              >
                <FaTrash size={14} />
              </button>
