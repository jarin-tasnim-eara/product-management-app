...
const LINKS = [
  { href: "/seller/dashboard", label: "Dashboard", icon: FaChartBar },
  { href: "/seller/products", label: "My Products", icon: FaBoxOpen },
  { href: "/seller/profile", label: "Profile", icon: FaUser },
  { href: "/seller/settings", label: "Settings", icon: FaCog },
];
...
export default function SellerSidebar() {
  ...
  return (
    <>
      ...
      {/* মোবাইলে sidebar খোলা থাকলে পেছনে dark overlay, ট্যাপ করলে বন্ধ হবে */}
      {open && (
        <div
      ...
      >
        <div className="flex items-center justify-between px-6 mb-8">
          <p className="text-xs text-white/40 uppercase tracking-wide">Seller Panel</p>
          <button
            onClick={() => setOpen(false)}
